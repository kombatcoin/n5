...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "N5coin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"seed1.N5coin.com", "seed1.N5coin.com"},
    {"seed2.N5coin.com", "seed2.N5coin.com"},
    {"seed3.N5coin.com", "seed3.N5coin.com"},
    {"seed4.N5coin.com", "seed4.N5coin.com"},
    {"seed5.N5coin.com", "seed5.N5coin.com"},
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("N5coin-dnsseed");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. N5coin is probably already running."), addrBind.ToString().c_str());
        else
