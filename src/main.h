...
#define FOUNDATION "5iQ45mZSxzo8VTJfuCybMEj2pUt4FSP4aS"
#define FOUNDATION_TEST "n1qw7HQ4dQCZgYMBu3pm7ktxFEsdF2GWJW"
...
static const uint256 hashGenesisBlock("00000f6c6338e360ab0db701546950c1a199dd7b1d040b257e5f974522173c0d");
static const uint256 hashGenesisBlockTestNet("00000c9e1e213c8a439a14f10b171586d4b3ea1836f67672f951a758398de14b");
...
public:
    ...
    {
        // N5coin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // N5coin: get transaction coin age
...
public:
    ...
    // N5coin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // N5coin: two types of block: proof-of-work or proof-of-stake
    ...
    // N5coin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // N5coin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // N5coin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // N5coin: block index flags
    enum  
    {
